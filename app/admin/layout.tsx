...
const PATH_PERMISSIONS: Array<[string, string | null]> = [
  ...
  ['/admin/account', null],
  ['/admin/orders', 'orders'],
  ['/admin/abandoned-cart', 'orders'],
  ['/admin/delivery', 'delivery'],
  ['/admin/rider', 'order_status'],
  ['/admin/pos', 'pos'],
  ['/admin/products', 'products'],
  ['/admin/bundles', 'products'],
  ...
  ['/admin/monthly-report', 'analytics'],
...
export default function AdminLayout({
  ...
  const menuItems = [
    ...
    { title: 'Messages',         icon: 'ri-mail-open-line',      path: '/admin/messages',                        permKey: 'customers' },
    ...
    { title: 'Promotions',       icon: 'ri-percent-line',        path: '/admin/promotions',                      permKey: 'coupons' },
    // { title: 'Customer Insights',icon: 'ri-user-search-line',    path: '/admin/customer-insights', moduleId: 'customer-insights' },
    { title: 'Product Bundles',  icon: 'ri-shopping-basket-2-line', path: '/admin/bundles',       moduleId: 'product-bundles', permKey: 'products' },
    { title: 'Abandoned Cart',   icon: 'ri-shopping-cart-line',  path: '/admin/abandoned-cart',  moduleId: 'abandoned-cart', permKey: 'orders' },
    { title: 'Monthly Report',   icon: 'ri-file-chart-line',     path: '/admin/monthly-report',  moduleId: 'monthly-reports', permKey: 'analytics' },
